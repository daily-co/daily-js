...
it('Session Data constructor fails with bad options', () => {
...
it('Session Data always has a valid mergeStrategy', () => {
...
it('SessionData clone is actually a clone', () => {
...
it('Setting Session Data to undefined should clear data', () => {
  let sd1 = new SessionData({ data: { foo: 'bar' } });
...
it('Setting Session Data to null is legit', () => {
  let sd1 = new SessionData({ data: { foo: 'bar' } });
...
it('shallow merge strategy works', () => {
...
it('top-level keys set to undefined should be deleted', () => {
...
it('updateFrom should return true if data actually changed', () => {
...
it('undefined values are preserved in stringify', () => {
