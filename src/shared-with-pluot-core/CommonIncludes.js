...
export const DAILY_EVENT_SIP_CONNECTED = 'sip-connected';
export const DAILY_EVENT_SIP_ERROR = 'sip-error';
export const DAILY_EVENT_SIP_STOPPED = 'sip-stopped';
export const DAILY_EVENT_SIP_WARNING = 'sip-warning';
export const DAILY_EVENT_DIALOUT_CONNECTED = 'dialout-connected';
export const DAILY_EVENT_DIALOUT_ERROR = 'dialout-error';
export const DAILY_EVENT_DIALOUT_MISSED = 'dialout-missed';
